  ...
  return (
    ...
    >
      ...
      <div style={{
        ...
        opacity: termOpacity * pulse, filter: "blur(80px)",
      }} />
      ...
      <div style={{
        ...
        <div style={{
          fontSize: 170, fontWeight: 900, color: HL,
          fontFamily: FONT,
      ...
      <div style={{
        ...
        <div style={{
          fontSize: 250, fontWeight: 900, color: HL,
          fontFamily: FONT,
